...
function mensajeExito(args) {
  ...
  const mensajes =
    noargs || isUndef(args.mensajes) ? deflt.mensajes : args.mensajes;
  const mostrarBotones =
    noargs || isUndef(args.mostrarBotones)
      ? deflt.mostrarBotones
      : args.mostrarBotones;
  const fijarMensaje =
    noargs || isUndef(args.fijarMensaje)
      ? deflt.fijarMensaje
      : args.fijarMensaje;
