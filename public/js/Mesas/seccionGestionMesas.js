$(document).ready(function() {
    ...
    $('#opcGestionarMesas').attr('style','border-left: 6px solid #185891; background-color: #131836;');
    $('#opcGestionarMesas').addClass('opcionesSeleccionado');
