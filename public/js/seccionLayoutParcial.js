...
function generarFilaTabla(layout_parcial){
  ...
  .append($('<td>').addClass('col-xs-2').text(layout_parcial.fecha))
  .append($('<td>').addClass('col-xs-2').text(layout_parcial.casino))
  .append($('<td>').addClass('col-xs-2').text(layout_parcial.sector))
