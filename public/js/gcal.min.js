 ...
 */
!function (e, t) {
  'object' == typeof exports && 'object' == typeof module ? module.exports = t(require('fullcalendar'), require('jquery'))  : 'function' == typeof define && define.amd ? define(['fullcalendar',
  'jquery'], t)  : 'object' == typeof exports ? t(require('fullcalendar'), require('jquery'))  : t(e.FullCalendar, e.jQuery)
      ...
      u = function (e) {
        ...
        t.prototype.fetch = function (e, t, r) {
          ...
          return a ? (this.calendar.pushLoading(), i.Promise.construct(function (e, t) {
            l.ajax(l.extend({
            }, i.JsonFeedEventSource.AJAX_DEFAULTS, u, {
              url: n,
              data: a,
              success: function (r, n, u) {
                ...
                r.error ? (o.reportError('Google Calendar API: ' + r.error.message, r.error.errors), t())  : r.items && (s = o.gcalItemsToRawEventDefs(r.items, a.timeZone), p = i.applyAll(c, o, [
                  r,
                  n,
                  u
                ]), l.isArray(p) && (s = p), e(o.parseEventDefs(s)))
              },
              error: function (e, r, n) {
                o.reportError('Google Calendar network failure: ' + r, [
                  e,
                  n
                ]),
                o.calendar.popLoading(),
