...
Route::group(['prefix' => 'autoexclusion', 'middleware' => 'tiene_permiso:ver_seccion_ae_alta'], function () {
  ...
  Route::get('logsDescarga','Autoexclusion\AutoexclusionController@logsDescarga')->middleware('tiene_permiso:logs_descargar_aes');
...
Route::group(['prefix' => 'canon', 'middleware' => "${CPermiso}:canon_ver"], function () use ($CPermiso) {
  ...
  Route::group(['middleware' => "${CPermiso}:canon_cargar"],function() use ($CPermiso){
    ...
    Route::delete('/borrar', '\App\Http\Controllers\Canon\CanonController@borrar_Req');
  });
  ...
  Route::group(['prefix' => 'pagos'],function() use ($CPermiso){
    Route::get('/obtener', '\App\Http\Controllers\Canon\CanonCuentaController@obtener_req');
    Route::get('/obtenerConHistorial', '\App\Http\Controllers\Canon\CanonCuentaController@obtenerConHistorial_req');
    Route::group(['middleware' => "${CPermiso}:canon_cargar"],function() use ($CPermiso){
      Route::post('/recalcular', '\App\Http\Controllers\Canon\CanonCuentaController@recalcular_req');
      Route::post('/guardar', '\App\Http\Controllers\Canon\CanonCuentaController@guardar_req');
    });
    Route::group(['middleware' => 'tiene_rol:superusuario'],function(){
  ...
  Route::group(['prefix' => 'agrupamientos', 'middleware' => "${CPermiso}:canon_agrupamiento_ver"] ,function() use ($CPermiso){
    ...
    Route::group(['middleware' =>  "${CPermiso}:canon_agrupamiento_cargar"],function(){
      Route::post('/guardar','\App\Http\Controllers\Canon\CanonAgrupamientoController@guardar');
...
Route::group(['prefix' => 'registrosDNI', 'middleware' => 'tiene_permiso:m_ver_seccion_importaciones'],function(){//@TODO: agregar permiso
  ...
  Route::post('/estadisticas','RegistrosDNIController@estadisticas');
});
