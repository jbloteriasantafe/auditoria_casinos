        ...
        <div id="collapseFiltros" class="panel-collapse collapse">
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-xs-4">
                <h5>Casino</h5>
                <select class="form-control" name="" id="CasInformeDiario" >
              ...
              <div class="col-xs-4" >
                <button id="buscar-informes-diarios" style="margin-top:30px" class="btn btn-infoBuscar" id="buscar-informes-diarios" type="button" name="button">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="table table-responsive"  >
              <table id="tablaInformesDiarios" class="table table-responsive tablesorter " width="100%">
                <thead>
                  <tr align="center" >
            ...
            <div class="table table-responsive" id="molde1" style="display:none" >
...
<script type="text/javascript" src="/js/InformesFiscalizadores/informeDiario.js"></script>
