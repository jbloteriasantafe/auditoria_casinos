              ...
              <div id="contenedorFormulario" style="background-color: #fff; padding: 30px 15px; margin: 10px;">
                  <!-- /.login-logo -->
                    <div class="login-logo">
                      <center><img src="img/logos/logo_brand.png" width="70%"></center> <!-- VER -->
                    </div>
          ...
          <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  ...
                  <a href="http://www.loteriasantafe.gov.ar/">
                      <img src="/img/logos/logo_brand_blanco.png" width="135px" style="float:right; margin:4px 5px 0px 5px;">
                  </a>
