  ...
  <div class="col-xl-9"> <!-- columna TABLA CASINOS -->
    ...
    <tr class="filaBusqueda">
      ...
      <td class="col-xs-3 acciones" style="text-align: left;">
        @if($usuario->tienePermiso('relevamiento_ver'))
...
@component('Relevamientos/cargarRelevamiento',compact('CONTADORES','CONTADORES_VISIBLES','tipos_causa_no_toma','denominaciones'))
@endcomponent
