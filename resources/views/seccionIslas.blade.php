...
@include('seccionIslas_asignarIslotes')
...
<script src="/js/seccionIslas.js?9" charset="utf-8"></script>
<script src="/js/seccionIslas_asignarIslotes.js?7" charset="utf-8"></script>
@endsection
