...
select[required] {
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-2">
                                  ...
                                  <select id="buscadorEstado" class="form-control selectEstado" name="">
                                      ...
                                      <option id="{{$estado->id_nombre_estado}}" value="{{$estado->id_nombre_estado}}">
                              ...
                              <div class="col-md-2">
                                  ...
                                  <select id="buscadorCasino" class="form-control selectCasinos" name="">
                                      ...
                                      <option id="{{$casino->id_casino}}" value="{{$casino->id_casino}}">
                                          {{$casino->nombre}}</option>
                                      @endforeach
                                      @foreach ($plataformas as $p)
                                      <option id="-{{$p->id_plataforma}}" value="-{{$p->id_plataforma}}">{{$p->nombre}}
                                      </option>
                                      @endforeach
                                  </select>
                              </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaAutoexclusionD">
                                      <input type="text" class="form-control" placeholder="Fecha de autoexclusion"
                                          id="buscadorFechaAutoexclusionD" autocomplete="off"
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaRenovacionD">
                                      <input type="text" class="form-control" placeholder="Fecha de renovación"
                                          id="buscadorFechaRenovacionD" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaVencimientoD">
                                      <input type="text" class="form-control" placeholder="Fecha de vencimiento"
                                          id="buscadorFechaVencimientoD" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                                      <span id="input-times-vencimiento" class="input-group-addon"
                                          style="border-left:none;cursor:pointer;"><i class="fa fa-times"></i></span>
                                      <span id="input-calendar-vencimiento" class="input-group-addon"
                                          style="cursor:pointer;"><i class="fa fa-calendar"></i></span>
                                  </div>
                              </div>
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaCierreDefinitivoD">
                                      <input type="text" class="form-control" placeholder="Fecha de cierre def."
                                          id="buscadorFechaCierreDefinitivoD" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                                      <span id="input-times-cierre-definitivo" class="input-group-addon"
                                          style="border-left:none;cursor:pointer;"><i class="fa fa-times"></i></span>
                                      <span id="input-calendar-cierre-definitivo" class="input-group-addon"
                                          style="cursor:pointer;"><i class="fa fa-calendar"></i></span>
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaAutoexclusionH">
                                      <input type="text" class="form-control" placeholder="Fecha de autoexclusion"
                                          id="buscadorFechaAutoexclusionH" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                                      <span id="input-times-autoexclusion" class="input-group-addon"
                                          style="border-left:none;cursor:pointer;"><i class="fa fa-times"></i></span>
                                      <span id="input-calendar-autoexclusion" class="input-group-addon"
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaRenovacionH">
                                      <input type="text" class="form-control" placeholder="Fecha de renovación"
                                          id="buscadorFechaRenovaciónH" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                                      <span id="input-times-renovacion" class="input-group-addon"
                                          style="border-left:none;cursor:pointer;"><i class="fa fa-times"></i></span>
                                      <span id="input-calendar-renovacion" class="input-group-addon"
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaVencimientoH">
                                      <input type="text" class="form-control" placeholder="Fecha de vencimiento"
                                          id="buscadorFechaVencimientoH" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                                      <span id="input-times-vencimiento" class="input-group-addon"
                                          style="border-left:none;cursor:pointer;"><i class="fa fa-times"></i></span>
                                      <span id="input-calendar-vencimiento" class="input-group-addon"
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="input-group date" id="dtpFechaCierreDefinitivoH">
                                      <input type="text" class="form-control" placeholder="Fecha de cierre def."
                                          id="buscadorFechaCierreDefinitivoH" autocomplete="off"
                                          style="background-color: rgb(255,255,255);" data-original-title="" title="">
                                      <span id="input-times-cierre-definitivo" class="input-group-addon"
                                          style="border-left:none;cursor:pointer;"><i class="fa fa-times"></i></span>
                                      <span id="input-calendar-cierre-definitivo" class="input-group-addon"
                      ...
                      <table id="tablaAutoexcluidos" class="table table-fixed tablesorter">
                          <thead>
                              <tr>
                                  ...
                                  <th class="col-xs-1" value="ae_datos.nro_dni" estado="">DNI<i class="fa fa-sort"></i>
                                  </th>
                                  <th class="col-xs-1" value="ae_datos.apellido" estado="">APELLIDO<i
                                          class="fa fa-sort"></i></th>
                                  <th class="col-xs-1" value="ae_datos.nombres" estado="">NOMBRES<i
                                          class="fa fa-sort"></i></th>
                                  <th class="col-xs-1 smalltext" value="ae_nombre_estado.descripcion" estado="">ESTADO<i
                                          class="fa fa-sort"></i></th>
                                  <th class="col-xs-1 smalltext" value="ae_estado.fecha_ae" estado="">F. AE<i
                                          class="fa fa-sort"></i></th>
                                  <th class="col-xs-1 smalltext " value="ae_estado.fecha_renovacion" estado="">F.
                                      RENOV<i class="fa fa-sort"></i></th>
                                  <th class="col-xs-1 smalltext" value="ae_estado.fecha_vencimiento" estado="">F. VENC<i
                                          class="fa fa-sort"></i></th>
                                  <th class="col-xs-1 smalltext" value="ae_estado.fecha_cierre_ae" estado="">F. CIERRE<i
                                          class="fa fa-sort"></i></th>
                          ...
                          <tbody id="cuerpoTabla" style="height: 350px;">
                              <tr class="filaTabla" style="display: none">
                                  ...
                                  <td class="col-xs-3 acciones">
                                      ...
                                      <button id="btnEditar" class="btn btn-info info" type="button" value=""
                                          title="EDITAR" data-toggle="tooltip" data-placement="top"
                                          data-delay="{'show':'300', 'hide':'100'}">
                                          <i class="fa fa-fw fa-pencil-alt"></i>
                                      </button>
                                      <button id="btnCambiarEstado" class="btn btn-info info" type="button" value=""
                                          title="" data-toggle="tooltip" data-placement="top"
                                          data-delay="{'show':'300', 'hide':'100'}">
                                          <i class="fa fa-fw"></i>
                                      </button>
                                      @endif
                                      <a tabindex="0" id="btnSubirArchivos" class="btn btn-info info" role="button"
                                          value="" title="SUBIR ARCHIVOS" data-toggle="popover" data-html="true"
                                          data-trigger="focus" data-content="">
                                          <i class="fa fa-fw fa-folder-open"></i>
                                      </a>
                                      <button id="btnGenerarSolicitudAutoexclusion" class="btn btn-info info"
                                          type="button" value="" title="GENERAR SOLICITUD AE" data-toggle="tooltip"
                                      ...
                                      <button id="btnEliminar" class="btn btn-info info" type="button" value=""
  ...
  <!-- MODAL AGREGAR AE-->
  <div class="modal fade" id="modalAgregarAE" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      aria-hidden="true">
          ...
          <div class="modal-content">
              <div class="modal-header" style="font-family: Roboto-Black; background-color: #6dc7be; color: #fff">
                  ...
                  <button id="btn-minimizar" type="button" class="close" data-toggle="collapse" data-minimizar="true"
                      data-target="#colapsado" style="position:relative; right:20px; top:5px"><i
              ...
              <div id="colapsado" class="collapse in">
                  <div class="modal-body modal-Cuerpo">
                      <form id="frmAgregarAE" class="form-horizontal" novalidate=" method=" post""
                                  ...
                                  <div id="columna" class="row">
                                      <div class="page step1">
                                          <div class="col-lg-6">
                                              ...
                                              <input id="nro_dni" type="text" class="form-control" placeholder=""
                                                  value="" required>
                                          </div>
                                      </div>
                                      <div class="page">
                                          ...
                                          <div class="step2">
                                              ...
                                              <div class="col-lg-6">
                                                  ...
                                                  <div class="input-group date" id="dtpFechaNacimiento"
                                                      ...
                                                      <input type="text" class="form-control"
                                                          ...
                                                          autocomplete="off" data-original-title="" title="" required>
                                              ...
                                              <div class="col-lg-3">
                                                  <h5>ESTADO CIVIL</h5>
                                                  <select id="id_estado_civil" class="form-control selectEstadoCivil"
                                                      name="id_estado_civil" required disabled>
                                                      @foreach ($estados_civiles as $estado_civil)
                                                      <option id="{{$estado_civil->id_estado_civil}}"
                                                          value="{{$estado_civil->id_estado_civil}}">
                                              ...
                                              <div class="col-lg-6">
                                                  <h5>DOMICILIO</h5>
                                                  <input id="domicilio" type="text" class="form-control" placeholder=""
                                                      value="" required>
                                              </div>
                                              <div class="col-lg-6">
                                                  <h5>NRO. DOMICILIO</h5>
                                              ...
                                              <div class="col-lg-6">
                                                  <h5>PISO</h5>
                                                  <input id="piso" type="text" class="form-control" placeholder=""
                                                      value="" data-size="5">
                                              </div>
                                              <div class="col-lg-6">
                                                  <h5>DEPARTAMENTO</h5>
                                                  <input id="dpto" type="text" class="form-control" placeholder=""
                                                      value="" data-size="5">
                                              </div>
                                              <div class="col-lg-6">
                                                  <h5>PROVINCIA</h5>
                                              ...
                                              <div class="col-lg-6">
                                                  ...
                                                  <input id="telefono" type="text" class="form-control" placeholder=""
                                                      value="" required numeric data-size="100">
                                              </div>
                                              <div class="col-lg-6">
                                                  <h5>EMAIL</h5>
                                                  <input id="correo" type="text" class="form-control" placeholder=""
                                                      value="" email data-size="100">
                                              </div>
                                              <div class="col-lg-6">
                                                  <h5>OCUPACIÓN</h5>
                                              ...
                                              <div class="col-lg-6">
                                                  ...
                                                  <select id="id_capacitacion" class="form-control" required disabled>
                                                      ...
                                                      <option id="{{$capacitacion->id_capacitacion}}"
                                                          value="{{$capacitacion->id_capacitacion}}">
                                                          {{$capacitacion->descripcion}}</option>
                                                      @endforeach
                                                  </select>
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-lg-6">
                                              <h5>PROVINCIA</h5>
                                              <input id="nombre_provincia_vinculo" type="text" class="form-control"
                                                  placeholder="" value="" data-size="200">
                                          </div>
                                          <div class="col-lg-6">
                                              <h5>LOCALIDAD</h5>
                                              <input id="nombre_localidad_vinculo" type="text" class="form-control"
                                                  placeholder="" value="" data-size="200">
                                          </div>
                                          <div class="col-lg-6">
                                              <h5>TELEFONO</h5>
                                          ...
                                          <div class="col-lg-6">
                                              <h5>VINCULO</h5>
                                              <input id="vinculo" type="text" class="form-control" placeholder=""
                                                  value="" data-size="200">
                                          </div>
                                      </div>
                                      <div class="page">
                          ...
                          ?>
                                                      ...
                                                      <option value="{{$casino->id_casino}}">{{$casino->nombre}}
                                                      </option>
                                                      @endforeach
                                                      @foreach ($plats_creacion as $p)
                                                      <option id="-{{$p->id_plataforma}}"
                                                          value="-{{$p->id_plataforma}}">{{$p->nombre}}</option>
                                                      @endforeach
                                                  </select>
                                              </div>
                                              <div class="col-lg-6">
                                                  ...
                                                  <select id="id_estado" class="form-control" required>
                                                      <option selected="" value="" required>- Seleccione un estado -
                                                      </option>
                                                      @foreach ($estados_elegibles as $estado)
                                                      <option id="{{$estado->id_nombre_estado}}"
                                                          value="{{$estado->id_nombre_estado}}">{{$estado->descripcion}}
                                                      </option>
                                                      @endforeach
                                                  </select>
                                              </div>
                                              ...
                                              <div class="col-lg-6">
                                                  ...
                                                  <input id="fecha_vencimiento_periodo" type="text" class="form-control"
                                              ...
                                              <div class="col-lg-6">
                                                  <h5>FECHA CIERRE DEFINITIVO</h5>
                                                  <input id="fecha_cierre_definitivo" type="text" class="form-control"
                                                      placeholder="" value="" disabled="" required>
                                              </div>
                                          </div>
                                          <div class="row">
                                      ...
                                      <div class="page">
                                          <div class="col-lg-12 no_esconder">
                                              ...
                                              <div
                                                  {{($usuario->es_superusuario || $usuario->es_administrador)? '' : 'hidden'}}>
                                                  Hace encuesta
                                                  <input type="checkbox" class="form-check-input" id="hace_encuesta"
                                                      checked>
                                              </div>
                                          </div>
                                          <div class="col-lg-3">
                                              ...
                                              <select id="juego_preferido" class="form-control">
                                                  ...
                                                  <option value="{{$juego->id_juego_preferido}}">{{$juego->nombre}}
                                                  </option>
                                                  @endforeach
                                              </select>
                                          </div>
                                          <div class="col-lg-3">
                                              ...
                                              <select id="id_frecuencia_asistencia" class="form-control">
                                                  ...
                                                  <option value="{{$frecuencia->id_frecuencia}}">{{$frecuencia->nombre}}
                                                  </option>
                                                  @endforeach
                                              </select>
                                          </div>
                                          <div class="col-lg-3">
                                              <h5>VECES</h5>
                                              <input id="veces" type="text" class="form-control" placeholder=""
                                                  value="">
                                          </div>
                                          <div class="col-lg-3">
                                              <h5>TIEMPO JUGANDO (HS)</h5>
                                              <input id="tiempo_jugado" type="text" class="form-control" placeholder=""
                                                  value="">
                                          </div>
                                          <div class="col-lg-6">
                                          ...
                                          <div class="col-lg-12">
                                              <h5>OBSERVACIONES</h5>
                                              <textarea id="observaciones" class="form-control" placeholder="" value=""
                                                  data-size="200"></textarea>
                                          </div>
                                      </div>
                                  </div>
                  ...
                  <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-successAceptar" id="btn-guardar"
  ...
  <div class="modal fade" id="modalVerMas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header modalVerMas"
                  style="font-family: Roboto-Black; background-color: #4FC3F7; color: #fff">
                  <button type="button" class="close" data-dismiss="modal"><i class="fa fa-times"></i></button>
                  <button id="btn-minimizar" type="button" class="close" data-toggle="collapse" data-minimizar="true"
                      data-target="#colapsado" style="position:relative; right:20px; top:5px"><i
                          class="fa fa-minus"></i></button>
                      ...
                      <form id="frmAutoExcluido" class="form-horizontal" novalidate="">
                          <div class="infoDatosPersonales">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>APELLIDO</h5>
                                      <input id="infoApellido" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>NOMBRES</h5>
                                      <input id="infoNombres" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>FECHA DE NACIMIENTO</h5>
                                      <input id="infoFechaNacimiento" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>DNI</h5>
                                      <input id="infoDni" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      <select id="infoEstadoCivil" class="form-control" disabled>
                                          ...
                                          @foreach ($estados_civiles as $estado_civil)
                                          <option id="{{$estado_civil->id_estado_civil}}"
                                              value="{{$estado_civil->id_estado_civil}}">{{$estado_civil->descripcion}}
                                          </option>
                                          @endforeach
                                      </select>
                                  </div>
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>DOMICILIO</h5>
                                      <input id="infoDomicilio" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>NRO. DOMICILIO</h5>
                                      <input id="infoNroDomicilio" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>PROVINCIA</h5>
                                      <input id="infoProvincia" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>LOCALIDAD</h5>
                                      <input id="infoLocalidad" class="form-control" type="text" class="form-control"
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>TELEFONO</h5>
                                      <input id="infoTelefono" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>EMAIL</h5>
                                      <input id="infoEmail" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      <select id="infoCapacitacion" class="form-control" disabled>
                                          ...
                                          @foreach ($capacitaciones as $capacitacion)
                                          <option id="{{$capacitacion->id_capacitacion}}"
                                              value="{{$capacitacion->id_capacitacion}}">{{$capacitacion->descripcion}}
                                          </option>
                                          @endforeach
                                      </select>
                                  </div>
                          ...
                          <div class="infoDatosContacto">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>NOMBRE Y APELLIDO</h5>
                                      <input id="infoNombreApellidoVinculo" type="text" class="form-control"
                                          placeholder="" value="" required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>DOMICILIO</h5>
                                      <input id="infoDomiclioVinculo" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>PROVINCIA</h5>
                                      <input id="infoProvinciaVinculo" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>LOCALIDAD</h5>
                                      <input id="infoLocalidadVinculo" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>TELÉFONO</h5>
                                      <input id="infoTelefonoVinculo" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>VÍNCULO</h5>
                                      <input id="infoVinculo" type="text" class="form-control" placeholder="" value=""
                                          required disabled>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="infoEstadoAutoexclusion">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      ...
                                      <select id="infoCasino" class="form-control selectCasinos" disabled>
                                          ...
                                          @endforeach
                                          @foreach ($plataformas as $p)
                                          <option id="-{{$p->id_plataforma}}" value="-{{$p->id_plataforma}}">
                                              {{$p->nombre}}</option>
                                          @endforeach
                                      </select>
                                  </div>
                                  <div class="col-lg-6">
                                      ...
                                      <select id="infoEstado" class="form-control selectEstado" disabled>
                                          ...
                                          @foreach ($estados_autoexclusion as $estado)
                                          <option id="{{$estado->id_nombre_estado}}"
                                              value="{{$estado->id_nombre_estado}}">{{$estado->descripcion}}</option>
                                          @endforeach
                                      </select>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>FECHA AUTOEXCLUSIÓN</h5>
                                      <input id="infoFechaAutoexclusion" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>VENCIMIENTO 1° PERÍODO</h5>
                                      <input id="infoFechaVencimiento" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>PERMITIR RENOVACIÓN DESDE</h5>
                                      <input id="infoFechaRenovacion" type="text" class="form-control" placeholder=""
                                          value="" required disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>FECHA CIERRE DEFINITIVO</h5>
                                      <input id="infoFechaCierreDefinitivo" type="text" class="form-control"
                                          placeholder="" value="" required disabled>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="archivosImportados">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>FOTO #1</h5>
                                      <button type="button" data-tipo="foto1" class="btn btn-default btn-ver-mas"
                                          style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                          aquí para ver el archivo correspondiente a Foto #1</button>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>FOTO #2</h5>
                                      <button type="button" data-tipo="foto2" class="btn btn-default btn-ver-mas"
                                          style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                          aquí para ver el archivo correspondiente a Foto #2</button>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>SCAN DNI</h5>
                                      <button type="button" data-tipo="scandni" class="btn btn-default btn-ver-mas"
                                          style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                          aquí para ver el archivo correspondiente al scan DNI</button>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>SOLICITUD AUTOEXCLUSIÓN</h5>
                                      <button type="button" data-tipo="solicitud_ae" class="btn btn-default btn-ver-mas"
                                          style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                          aquí para ver el archivo correspondiente a la SAE</button>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>SOLICITUD DE FINALIZACIÓN</h5>
                                      <button type="button" data-tipo="solicitud_revocacion"
                                          class="btn btn-default btn-ver-mas"
                                          style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                          aquí para ver el archivo correspondiente a la SAE</button>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>CARATULA</h5>
                                      <button type="button" data-tipo="caratula" class="btn btn-default btn-ver-mas"
                                          style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                          aquí para ver el archivo correspondiente a la SAE</button>
                                  </div>
                              </div>
                          ...
                          <div class="infoEncuesta">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-lg-3">
                                      <h5>VECES</h5>
                                      <input id="infoVeces" type="text" class="form-control" placeholder="" value=""
                                          disabled>
                                  </div>
                                  <div class="col-lg-3">
                                      <h5>TIEMPO JUGANDO (HS)</h5>
                                      <input id="infoTiempoJugado" type="text" class="form-control" placeholder=""
                                          value="" disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>¿ES SOCIO DEL CLUB DE JUGADORES?</h5>
                                      <input id="infoSocioClubJugadores" type="text" class="form-control" placeholder=""
                                          value="" disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>¿CONOCE EL PROGRAMA JUEGO RESPONSABLE?</h5>
                                      <input id="infoJuegoResponsable" type="text" class="form-control" placeholder=""
                                          value="" disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>¿DECISIÓN POR PROBLEMAS DE AUTOCONTROL?</h5>
                                      <input id="infoAutocontrol" type="text" class="form-control" placeholder=""
                                          value="" disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>¿CÓMO ASISTE?</h5>
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <h5>¿DESEA RECIBIR INFORMACIÓN SOBRE JR?</h5>
                                      <input id="infoRecibirInformacion" type="text" class="form-control" placeholder=""
                                          value="" disabled>
                                  </div>
                                  <div class="col-lg-6">
                                      <h5>¿MEDIO DE RECEPCIÓN?</h5>
                                      <input id="infoMedioRecepcion" type="text" class="form-control" placeholder=""
                                          value="" disabled>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-lg-12">
                                      <h5>OBSERVACIONES</h5>
                                      <input id="infoObservaciones" class="form-control" placeholder="" value=""
                                          disabled>
                                  </div>
                              </div>
                          </div>
      ...
      <div class="modal-dialog" style="width: 37%">
          <div class="modal-content">
              <div class="modal-header modalNuevo" style="background-color: #6dc7be;">
                  <button type="button" class="close" data-dismiss="modal"><i class="fa fa-times"></i></button>
                  <button id="btn-minimizarCrear" type="button" class="close" data-toggle="collapse"
                      data-minimizar="true" data-target="#colapsadoCrear"
  ...
  <div class="modal fade" id="modalFormulariosAE" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header" style="font-family: Roboto-Black; background-color: #6dc7be; color: #fff">
              ...
              <div id="colapsado" class="collapse in">
                  <div class="modal-body">
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                              <h5>Carátula AU 1°</h5>
                              <button id="1" type="button" class="btn btn-default btn-ver-formulario"
                                  style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  aquí para ver la Carátula AU 1°</button>
                          </div>
                          <div class="col-lg-6">
                              <h5>Carátula AU 2°</h5>
                              <button id="2" type="button" class="btn btn-default btn-ver-formulario"
                                  style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  aquí para ver la Carátula AU 2°</button>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-lg-6">
                              <h5>Formulario AU 1°</h5>
                              <button id="3" type="button" class="btn btn-default btn-ver-formulario"
                                  style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  aquí para ver el Formulario AU 1°</button>
                          </div>
                          <div class="col-lg-6">
                              <h5>Formulario AU 2°</h5>
                              <button id="4" type="button" class="btn btn-default btn-ver-formulario"
                                  style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  aquí para ver el Formulario AU 2°</button>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-lg-6">
                              <h5>Formulario Finalización AU</h5>
                              <button id="5" type="button" class="btn btn-default btn-ver-formulario"
                                  style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  aquí para ver el Formulario Finalización AU</button>
                          </div>
                          <div class="col-lg-6">
                              <h5>RVE N°983</h5>
                              <button id="6" type="button" class="btn btn-default btn-ver-formulario"
                                  style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  aquí para ver la RVE N°983</button>
                          </div>
                      </div>
                  </div>
                  <div class="modal-footer">
