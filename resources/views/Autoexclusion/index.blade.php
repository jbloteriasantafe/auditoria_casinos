  ...
  @section('contenidoVista')
                              ...
                              <thead>
                                  <tr>
                                      ...
                                      <th class="col-xs-1" value="ae_datos.nombres" estado="">NOMBRES<i
                                              class="fa fa-sort"></i></th>
                                      <th class="col-xs-1 smalltext" value="ae_nombre_estado.descripcion" estado="">
                                          ESTADO<i class="fa fa-sort"></i></th>
                                      <th class="col-xs-1 smalltext" value="ae_estado.fecha_ae" estado="">F. AE<i
                                              class="fa fa-sort"></i></th>
                                      <th class="col-xs-1 smalltext " value="ae_estado.fecha_renovacion" estado="">
                                          F.
                                          RENOV<i class="fa fa-sort"></i></th>
                                      <th class="col-xs-1 smalltext" value="ae_estado.fecha_vencimiento" estado="">
                                          F. VENC<i class="fa fa-sort"></i></th>
                                      <th class="col-xs-1 smalltext" value="ae_estado.fecha_cierre_ae" estado="">F.
                                          CIERRE<i class="fa fa-sort"></i></th>
                                  ...
                                  <tr class="filaTabla" style="display: none">
                                      ...
                                      <td class="col-xs-3 acciones">
                                          ...
                                          @if ($usuario->tienePermiso('modificar_ae'))
                                              ...
                                              <button id="btnCambiarEstado" class="btn btn-info info" type="button"
                                                  value="" title="" data-toggle="tooltip"
                                                  data-placement="top" data-delay="{'show':'300', 'hide':'100'}">
                                                  <i class="fa fa-fw"></i>
                                              </button>
                                          @endif
                                          <a tabindex="0" id="btnSubirArchivos" class="btn btn-info info"
                                              role="button" value="" title="SUBIR ARCHIVOS" data-toggle="popover"
                                          ...
                                          @if ($usuario->es_superusuario)
                                              <button id="btnEliminar" class="btn btn-info info" type="button"
                                                  value="" title="ELIMINAR" data-toggle="tooltip"
                                                  data-placement="top" data-delay="{'show':'300', 'hide':'100'}">
                                                  <i class="fa fa-fw fa-trash"></i>
                                              </button>
                                          @endif
                                          @if ($usuario->es_superusuario)
                                              <button id="btnEnviarEmail" class="btn btn-info info" type="button"
                                                  value="" title="ENVIAR EMAIL DE VERIFICACIÓN"
                                                  data-toggle="tooltip" data-placement="top"
                                                  data-delay="{'show':'300', 'hide':'100'}">
      ...
      <!-- MODAL AGREGAR AE-->
      <div class="modal fade" id="modalAgregarAE" tabindex="-1" role="dialog" aria-hidden="true">
                                              ...
                                              <div class="step3">
                                                  <div class="col-lg-6">
                                                      ...
                                                      <select id="id_casino" class="form-control" required>
                                                          <option selected="" value="">- Seleccione un casino -
                                                          </option>
                                                          <?php
                                                          ...
                                                          @foreach ($cas_creacion as $casino)
                                                              <option value="{{ $casino->id_casino }}">
                                                                  {{ $casino->nombre }}
                                                              </option>
                                                          @endforeach
                                                          @foreach ($plats_creacion as $p)
                                                              <option id="-{{ $p->id_plataforma }}"
                                                                  value="-{{ $p->id_plataforma }}">{{ $p->nombre }}
                                                              </option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                                  <div class="col-lg-6">
                                                      ...
                                                      <select id="id_estado" class="form-control" required>
                                                          <option selected="" value="" required>- Seleccione un
                                                              estado -
                                                          </option>
                                          ...
                                          <div class="page">
                                              ...
                                              <div class="col-lg-3">
                                                  ...
                                                  <select id="juego_preferido" class="form-control">
                                                      ...
                                                      @foreach ($juegos as $juego)
                                                          <option value="{{ $juego->id_juego_preferido }}">
                                                              {{ $juego->nombre }}
                                                          </option>
                                                      @endforeach
                                                  </select>
                                              ...
                                              <div class="col-lg-3">
                                                  ...
                                                  <select id="id_frecuencia_asistencia" class="form-control">
                                                      <option selected="" value="">- Seleccione un valor -
                                                      </option>
                          ...
                          <form id="frmAutoExcluido" class="form-horizontal" novalidate="">
                              <div class="infoDatosPersonales">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>APELLIDO</h5>
                                          <input id="infoApellido" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>NOMBRES</h5>
                                          <input id="infoNombres" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>FECHA DE NACIMIENTO</h5>
                                          <input id="infoFechaNacimiento" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>DNI</h5>
                                          <input id="infoDni" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>DOMICILIO</h5>
                                          <input id="infoDomicilio" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>NRO. DOMICILIO</h5>
                                          <input id="infoNroDomicilio" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>PROVINCIA</h5>
                                          <input id="infoProvincia" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>LOCALIDAD</h5>
                                          <input id="infoLocalidad" class="form-control" type="text"
                                              class="form-control" placeholder="" value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>TELEFONO</h5>
                                          <input id="infoTelefono" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>EMAIL</h5>
                                          <input id="infoEmail" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          ...
                                          <select id="infoOcupacion" class="form-control" disabled>
                                              <option selected="" value="">No ingresado</option>
                                              @foreach ($ocupaciones as $ocupacion)
                                                  <option value="{{ $ocupacion->id_ocupacion }}">{{ $ocupacion->nombre }}
                                                  </option>
                                              @endforeach
                                          </select>
                                      </div>
                              ...
                              <div class="infoDatosContacto">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <h5>DOMICILIO</h5>
                                          <input id="infoDomiclioVinculo" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>PROVINCIA</h5>
                                          <input id="infoProvinciaVinculo" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>LOCALIDAD</h5>
                                          <input id="infoLocalidadVinculo" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>TELÉFONO</h5>
                                          <input id="infoTelefonoVinculo" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>VÍNCULO</h5>
                                          <input id="infoVinculo" type="text" class="form-control" placeholder=""
                                              value="" required disabled>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="infoEstadoAutoexclusion">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          ...
                                          <select id="infoCasino" class="form-control selectCasinos" disabled>
                                              <option value="0">Todos los Casinos</option>
                                              @foreach ($casinos as $casino)
                                                  <option id="{{ $casino->id_casino }}"
                                                      value="{{ $casino->id_casino }}">
                                                      {{ $casino->nombre }}</option>
                                              @endforeach
                                              @foreach ($plataformas as $p)
                                                  <option id="-{{ $p->id_plataforma }}"
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>FECHA AUTOEXCLUSIÓN</h5>
                                          <input id="infoFechaAutoexclusion" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>VENCIMIENTO 1° PERÍODO</h5>
                                          <input id="infoFechaVencimiento" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>PERMITIR RENOVACIÓN DESDE</h5>
                                          <input id="infoFechaRenovacion" type="text" class="form-control"
                                              placeholder="" value="" required disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>FECHA CIERRE DEFINITIVO</h5>
                              ...
                              <div class="archivosImportados">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>SCAN DNI</h5>
                                          <button type="button" data-tipo="scandni"
                                      ...
                                      <div class="col-lg-6">
                                          <h5>SOLICITUD AUTOEXCLUSIÓN</h5>
                                          <button type="button" data-tipo="solicitud_ae"
                                              class="btn btn-default btn-ver-mas"
                                              style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <h5>CARATULA</h5>
                                          <button type="button" data-tipo="caratula"
                                              class="btn btn-default btn-ver-mas"
                                              style="width:419px; background-color: #4FC3F7 !important; color: white; font-weight: bold;">Click
                                              aquí para ver el archivo correspondiente a la SAE</button>
                                      </div>
                              ...
                              <div class="infoEncuesta">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-3">
                                          <h5>VECES</h5>
                                          <input id="infoVeces" type="text" class="form-control" placeholder=""
                                              value="" disabled>
                                      </div>
                                      <div class="col-lg-3">
                                          <h5>TIEMPO JUGANDO (HS)</h5>
                                          <input id="infoTiempoJugado" type="text" class="form-control"
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>¿ES SOCIO DEL CLUB DE JUGADORES?</h5>
                                          <input id="infoSocioClubJugadores" type="text" class="form-control"
                                              placeholder="" value="" disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>¿CONOCE EL PROGRAMA JUEGO RESPONSABLE?</h5>
                                          <input id="infoJuegoResponsable" type="text" class="form-control"
                                              placeholder="" value="" disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>¿DECISIÓN POR PROBLEMAS DE AUTOCONTROL?</h5>
                                          <input id="infoAutocontrol" type="text" class="form-control"
                                              placeholder="" value="" disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>¿CÓMO ASISTE?</h5>
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <h5>¿DESEA RECIBIR INFORMACIÓN SOBRE JR?</h5>
                                          <input id="infoRecibirInformacion" type="text" class="form-control"
                                              placeholder="" value="" disabled>
                                      </div>
                                      <div class="col-lg-6">
                                          <h5>¿MEDIO DE RECEPCIÓN?</h5>
                                          <input id="infoMedioRecepcion" type="text" class="form-control"
                                              placeholder="" value="" disabled>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-12">
                                          <h5>OBSERVACIONES</h5>
                                          <input id="infoObservaciones" class="form-control" placeholder=""
                                              value="" disabled>
                                      </div>
                                  </div>
                              </div>
                  ...
                  <div id="colapsadoCrear" class="collapse in">
                      <div class="modal-body modalCuerpo">
                          <div class="row">
                              <div class="col-md-6">
                                  <h5>NÚMERO DE DOCUMENTO</h5>
                                  <input type="text" class="form-control nro_dni" placeholder="" value=""
                                      required disabled>
                                  <br>
                              </div>
                              <div class="col-md-6">
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-successAceptar" id="btn-subir-archivo">SUBIR
                              ARCHIVO</button>
