                        ...
                        <div class="panel-body">
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              ...
                              <button id="buscarCertificado" class="btn btn-infoBuscar" type="button" name="button"><i class="fa fa-fw fa-search"></i> BUSCAR</button>
                            </div>
                          </div>
                        </div>
                      </div>
                    </div>
                  </div> <!-- fin columna FILTRO -->
                </div> <!-- fin fila FILTRO -->
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <table id="tablaGliHard" class="table table-fixed tablesorter">
                            <thead>
                              <tr>
                                <th class="col-xs-4" value="gli_hard.nro_archivo" estado="">CÓDIGO DE CERTIFICADO  <i class="fa fa-sort"></i></th>
                                <th class="col-xs-5" value="archivo.nombre_archivo" estado="">NOMBRE DEL ARCHIVO  <i class="fa fa-sort"></i></th>
              ...
              <div class="col-xl-12 col-lg-4">
               <a href="" id="btn-nuevo" style="text-decoration: none;">
                <div class="panel panel-default panelBotonNuevo">
                    <center><img class="imgNuevo" src="/img/logos/hardware_white.png"><center>
              ...
              <div class="col-xl-12 col-lg-4">
                  <!-- <a href="certificadoSoft" style="text-decoration:none;">
                      <div class="tarjetaSeccionMenor" align="center">
                        <h2 class="tituloFondoMenor">SOFTWARE</h2>
...
@section('scripts')
    ...
    <script src="js/seccionGLIHard.js?2"></script>
    ...
    <script type="text/javascript">
        ...
        $('#cargaArchivo').on('fileerror', function(event, data, msg) {
            console.log('Eventos del pdf');
           console.log(data.id);
        ...
        $('#cargaArchivo').on('fileselect', function(event, numFiles, label) {
