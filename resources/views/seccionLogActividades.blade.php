      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <table hidden>
              <tr id="moldeLog">
                <td class="col-md-2 col-xs-3 usuario">USUARIO</td>
                <td class="col-md-2 col-xs-4 fecha">9999-99-99 99:99:99</td>
                <td class="col-md-2 accion">ACCIÓN</td>
                <td class="col-md-2 col-xs-3 tabla">TABLA</td>
                <td class="col-md-2 id_entidad">ID ENTIDAD</td>
                <td class="col-md-2 col-xs-2">
                  <button class="btn btn-info detalle" title="VER MÁS">
...
<div class="modal fade" id="modalLogActividad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background: #4FC3F7;color: #fff;">
        <button type="button" class="close" data-dismiss="modal"><i class="fa fa-times"></i></button>
        <button id="btn-minimizar" type="button" class="close" data-toggle="collapse" data-minimizar="true" data-target="#colapsado" style="position:relative; right:20px; top:5px"><i class="fa fa-minus"></i></button>
        <h3 class="modal-title modalVerMas" id="myModalLabel">| VER DETALLE LOG</h3>
      </div>
          ...
          <form id="frmLog" name="frmLog" class="form-horizontal" novalidate="">
            ...
            <div class="row"> <!-- Tarjeta TABLA log Actividades -->
              <div class="col-md-12">
                ...
                <table hidden>
                  <tr id="moldeCampoValor">
                    <td class="col-xs-6 campo">CAMPOCAMPO</td>
                    <td class="col-xs-6 valor">99999</td>
                  </tr>
                </table>
              </div>
            </div> <!-- / Tarjeta TABLA -->
...
<h3 class="modal-title" style="color: #fff;">| LOG DE ACTIVIDADES</h3>
@endsection
...
<script src="js/seccionLogActividades.js?2" charset="utf-8"></script>
