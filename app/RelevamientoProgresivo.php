...
class RelevamientoProgresivo extends Model
{
  ...
  protected $visible = array('id_relevamiento_progresivo','nro_relevamiento_progresivo','subrelevamiento','backup','fecha','fecha_generacion','fecha_ejecucion','fecha_carga','observacion_carga','observacion_validacion','id_estado_relevamiento');
